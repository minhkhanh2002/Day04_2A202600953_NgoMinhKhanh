...
class OrderDataStore:
    def __init__(self, data_dir: Path, output_dir: Path, *, today: str | None = None) -> None:
        ...
        self.normalized_product_names = {
            product.product_id: _normalize(product.name) for product in self.products
        }
    ...
    def list_products(
        ...
        *,
        ...
        query_terms = [
            term for term in normalized_query.split() if term and not term.isdigit() and len(term) > 1
        ]
            ...
            results.append(
                (
                    ...
                    product.product_id,
                    {
                        ...
                        "next_step": "Call get_product_details with chosen product_id values before pricing.",
                    },
                )
            )
